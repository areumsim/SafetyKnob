...
> 프로젝트의 전체 구조와 파일별 상세 설명은 [PROJECT_STRUCTURE_ko.md](PROJECT_STRUCTURE_ko.md)를 참조하세요.
...
### 디렉토리 구조
프로젝트의 상세한 파일별 설명은 [프로젝트 구조 문서](PROJECT_STRUCTURE_ko.md)를 참조하세요.
...
자세한 REST API 문서는 [API 레퍼런스](API_REFERENCE_ko.md)를 참조하세요.
...
**결론**: SafetyKnob은 전통적 fine-tuning 대비 더 높은 성능을 더 적은 훈련 시간으로 달성 (초기 결과)
...
배포 전 확인사항:
- [ ] API endpoint 보안 강화 (HTTPS, API key 인증)
...
- **연구 이해**: [RESEARCH_METHODOLOGY_ko.md](RESEARCH_METHODOLOGY_ko.md) → [DATASET_GUIDE_ko.md](DATASET_GUIDE_ko.md)
- **실험 수행**: [EXPERIMENT_PROTOCOL.md](EXPERIMENT_PROTOCOL.md) → 현재 문서(DEVELOPMENT_ko.md)
- **API 사용**: [API_REFERENCE_ko.md](API_REFERENCE_ko.md)
- **코드 구조**: [PROJECT_STRUCTURE_ko.md](PROJECT_STRUCTURE_ko.md)
